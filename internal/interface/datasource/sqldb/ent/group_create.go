...
func (gc *GroupCreate) SetParent(i int) *GroupCreate {
	gc.mutation.SetParent(i)
	return gc
}
...
func (gc *GroupCreate) check() error {
	...
	if _, ok := gc.mutation.Parent(); !ok {
		return &ValidationError{Name: "parent", err: errors.New(`ent: missing required field "Group.parent"`)}
	}
...
func (gc *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := gc.mutation.Parent(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
