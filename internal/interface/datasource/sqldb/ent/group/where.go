...
func Parent(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ParentEQ(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldParent), v))
	})
}
...
func ParentNEQ(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ParentIn(vs ...int) predicate.Group {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ParentNotIn(vs ...int) predicate.Group {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ParentGT(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ParentGTE(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ParentLT(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
func ParentLTE(v int) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
